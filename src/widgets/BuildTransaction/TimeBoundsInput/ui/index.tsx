...
const TimeBoundsInput: FC = () => {
  ...
  const initialMinTime = Number(searchParams.get("lowerTime")) || tx.tx.cond?.time?.min_time || 0;
  const initialMaxTime = Number(searchParams.get("upperTime")) || tx.tx.cond?.time?.max_time || 0;
